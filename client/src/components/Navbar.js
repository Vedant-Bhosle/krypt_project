...
<li className="bg-[#2952e3] py-2 px-7 mx-4 rounded-full cursor-pointer hover:bg-[#2546bd]"><NavLink to="/login">Login</NavLink>
</li>
<li className="bg-[#2952e3] py-2 px-7 mx-4 rounded-full cursor-pointer hover:bg-[#2546bd]"><NavLink to="/signup">Register</NavLink></li>
</ul>

<div className="flex relativer">
