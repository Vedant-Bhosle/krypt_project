...
function Services() {
  return (
    <div className="flex flex-col md:flex-row w-full justify-center items-center gradient-bg-services bg-gradient-services">
...
subtitle="Security is  Guaranteed. We always maintain the privacy and maintaining the quality of our product"/>
